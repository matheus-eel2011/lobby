# Script de Setup - Sistema de Autenticação (src/)
...
Write-Host "$green✓ Iniciando setup de autenticação em src/...$reset`n"

# ===========================
# 1. Criar src/lib/supabase.ts
# ===========================
Write-Host "$yellow[1/5]$reset Criando src/lib/supabase.ts..."
...
$supabaseCode | Out-File -FilePath "src/lib/supabase.ts" -Encoding UTF8
Write-Host "$green✓ src/lib/supabase.ts criado$reset`n"

# ===========================
# 2. Criar src/lib/auth.ts
# ===========================
Write-Host "$yellow[2/5]$reset Criando src/lib/auth.ts..."
...
$authCode | Out-File -FilePath "src/lib/auth.ts" -Encoding UTF8
Write-Host "$green✓ src/lib/auth.ts criado$reset`n"

# ===========================
# 3. Criar src/app/auth/login/page.tsx
# ===========================
Write-Host "$yellow[3/5]$reset Criando src/app/auth/login/page.tsx..."
...
if (-not (Test-Path "src/app/auth/login")) {
    New-Item -ItemType Directory -Path "src/app/auth/login" -Force | Out-Null
}

$loginCode | Out-File -FilePath "src/app/auth/login/page.tsx" -Encoding UTF8
Write-Host "$green✓ src/app/auth/login/page.tsx criado$reset`n"

# ===========================
# 4. Criar src/app/auth/register/page.tsx
# ===========================
Write-Host "$yellow[4/5]$reset Criando src/app/auth/register/page.tsx..."
...
# Criar pasta se não existir
if (-not (Test-Path "src/app/auth/register")) {
    New-Item -ItemType Directory -Path "src/app/auth/register" -Force | Out-Null
}

$registerCode | Out-File -FilePath "src/app/auth/register/page.tsx" -Encoding UTF8
Write-Host "$green✓ src/app/auth/register/page.tsx criado$reset`n"
...
Write-Host "  ✓ src/app/auth/login/page.tsx"
Write-Host "  ✓ src/app/auth/register/page.tsx`n"
